<template>
    <view class="container">
        ...
        <view class="brands watch" v-show="type === 'watch'">
            <view class="tabs">
                <view class="active"><text>手表</text></view>
            </view>
            <view class="brand-box">
                <view
                        class="box"
        ...
        <view class="brands Luxury" v-show="type === 'Luxury'">
            <view class="tabs">
                <view class="active"><text>奢侈品</text></view>
            </view>
            <view class="brand-box">
                <view
                        class="box"
        ...
        <view class="brands beauty" v-show="type === 'beauty'">
            <view class="tabs">
                <view class="active"><text>美妆</text></view>
            </view>
            <view class="brand-box">
                <view
                        class="box"
